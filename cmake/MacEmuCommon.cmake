...
function(macemu_find_sdl)
	if(USE_SDL3)
		...
		if(NOT SDL3_FOUND)
			...
			get_target_property(_type ${MACEMU_SDL_TARGET} TYPE)
			get_target_property(_links ${MACEMU_SDL_TARGET} INTERFACE_LINK_LIBRARIES)
			get_target_property(_incs ${MACEMU_SDL_TARGET} INTERFACE_INCLUDE_DIRECTORIES)

			message(STATUS "SDL3 target: ${MACEMU_SDL_TARGET}")
			message(STATUS "SDL3 type:   ${_type}")
			message(STATUS "SDL3 links:  ${_links}")
			message(STATUS "SDL3 incs:   ${_incs}")


			get_target_property(_loc SDL3::SDL3 IMPORTED_LOCATION)
			get_target_property(_loc_debug SDL3::SDL3 IMPORTED_LOCATION_DEBUG)
			get_target_property(_loc_release SDL3::SDL3 IMPORTED_LOCATION_RELEASE)
			get_target_property(_implib SDL3::SDL3 IMPORTED_IMPLIB)
			get_target_property(_implib_debug SDL3::SDL3 IMPORTED_IMPLIB_DEBUG)
			get_target_property(_implib_release SDL3::SDL3 IMPORTED_IMPLIB_RELEASE)

			message(STATUS "location:        ${_loc}")
			message(STATUS "location debug:  ${_loc_debug}")
			message(STATUS "location release:${_loc_release}")
			message(STATUS "implib:          ${_implib}")
			message(STATUS "implib debug:    ${_implib_debug}")
			message(STATUS "implib release:  ${_implib_release}")
